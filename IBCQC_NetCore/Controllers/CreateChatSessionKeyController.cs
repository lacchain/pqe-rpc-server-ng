...
namespace IBCQC_NetCore.Controllers
{
    ...
    [ApiController]
    public class CreateChatSessionKeyController : ControllerBase
    {
        private static CallerInfo callerInfo;
        private static CallerInfo participatingPartyInfo;
        private static string certSerial;
        private readonly ILogger<CreateChatSessionKeyController> _logger;

        public CreateChatSessionKeyController(ILogger<CreateChatSessionKeyController> logger)
        {
            _logger = logger;
        }
        ...
        // GET api/createChatSessionKey/invitedcertserial
